@AbapCatalog.sqlViewName: 'ZI5RPT45'
...

{
 ...
 //     _Version,
  ...
  then AmountInGroupCurrency end as CYQTD,
  ...
  case when LYEAR is not null and LYQTR = $parameters.p_qtr
   then AmountInGroupCurrency end as LYQTD,
  ...
  @Semantics.amount.currencyCode: 'GroupCurrency'
  case when CYEAR is not null and CYQTR <= $parameters.p_qtr 
            then AmountInGroupCurrency end as CYYTD,
  ...
  @Semantics.amount.currencyCode: 'GroupCurrency' 
  case when LYEAR is not null and LYQTR <= $parameters.p_qtr 
            then AmountInGroupCurrency  end as LYYTD,
  ...
  case when LYEAR is not null
            then AmountInGroupCurrency end as LY,
  ...
  case when L2LYEAR is not null
            then AmountInGroupCurrency end as L2LY 
}
