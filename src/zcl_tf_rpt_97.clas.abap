CLASS zcl_tf_rpt_97 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
   ...
   CLASS-METHODS get_rpt97_nof FOR TABLE FUNCTION ZTF_RPT_97_1.
  CLASS-METHODS get_rpt97 FOR TABLE FUNCTION ZTF_RPT_97.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS zcl_tf_rpt_97 IMPLEMENTATION.
METHOD get_rpt97_nof
 BY DATABASE FUNCTION FOR HDB LANGUAGE SQLSCRIPT OPTIONS READ-ONLY "CDS SESSION CLIENT current
   USING   CEPC  ZB_SS_PROFCTR_HIER ZB_2_RPT_0039 .

lt_gldata1 =
 select distinct
     _phier.NodeValue AS ProfitCenter,
      h1.district
    from       ZB_SS_PROFCTR_HIER as _phier
   ...
   inner join ZB_2_RPT_0039 as h1 on h1.NodeValue = _phier.NodeValue
     where _phier.HierarchyClass = 'PSCO';
******************************************************************************
 lt_gldatasum1 =
  select DISTINCT
        ProfitCenter,
        district,
        count (distinct ProfitCenter) as NoOfFacility
...
METHOD get_rpt97
 BY DATABASE FUNCTION FOR HDB LANGUAGE SQLSCRIPT OPTIONS READ-ONLY "CDS SESSION CLIENT current
   USING  I_GLAccountLineItem ztrpt_fi_mstr
    skat ska1 cepc  ZI_STAT_DERIV_PDATE ZB_SS_PROFCTR_HIER ZB_2_RPT_0039.
...
lt_gldata1 = select distinct
 ...
 select distinct
  ...
  and  _MSTR.rptid           = 'RPT97' and  _MSTR.counter <> 1;
******************************************************************************
 lt_gldatasum =
  select Mainnode,
         Subnode,
