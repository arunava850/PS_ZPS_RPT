...
// SQL View Name
@AbapCatalog.sqlViewName: 'ZQGRATR32_Q1'
// Query Name
@EndUserText.label: 'RPT0032 - Ancillary Table'
...
define view ZQ_GR_FSI_AT_R032_Q0001
  with parameters
...

{
  ...
  key ConsolidationLedger,
      ...
      @AnalyticsDetails.query.axis: #COLUMNS
      @Consumption.hidden: false
      @EndUserText.label: 'Quarterly Change'
      @DefaultAggregation: #SUM
      @Semantics.amount.currencyCode:'GroupCurrency'
      QTD_Change,
      ...
      @AnalyticsDetails.query.axis: #COLUMNS
      @Consumption.hidden: false
      @EndUserText.label: 'Yearly Change'
      @DefaultAggregation: #SUM
      @Semantics.amount.currencyCode:'GroupCurrency'
      YTD_Change
}
