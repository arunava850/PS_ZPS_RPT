@AbapCatalog.sqlViewName: 'ZI4RPT45'
 ...
 //     _Version,
  ...
  ZMONTH,
   ...
   case  when ZMONTH = '01' then '1'
    ...
    case when ZLYEAR = substring(FiscalYearQuarter,1,4) 
              then substring(FiscalYearQuarter,5,1)        end as LYQTR,
    
    case when ZYEAR = substring(FiscalYearQuarter,1,4)  
              then substring(FiscalYearQuarter,1,4)        end as CYEAR,
        
    case when ZYEAR = substring(FiscalYearQuarter,1,4) 
              then substring(FiscalYearQuarter,5,1)        end as CYQTR, 
              
    case when ZLYEAR = substring(FiscalYearQuarter,1,4)  
              then substring(FiscalYearQuarter,1,4)        end as LYEAR, 
    
    case when ZL2LYEAR = substring(FiscalYearQuarter,1,4) 
              then substring(FiscalYearQuarter,1,4)        end as L2LYEAR         
}
