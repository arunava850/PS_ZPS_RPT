@AbapCatalog.sqlViewName: 'ZC95COMPREP'
...
define view ZC_95_COMP_REP 
with parameters
    P_FromPostingDate : fis_budat_from,
    P_ToPostingDate   : fis_budat_to
   
as select from ZI_95_ACD_PFHIER
...
// FINANCIAS - KPIs........................
 ...
 case when FI_LASTYR_QTD is not null and FI_CURRENT_QTD is not null then FI_CURRENT_QTD - FI_LASTYR_QTD
      when FI_LASTYR_QTD is null     and FI_CURRENT_QTD is not null then FI_CURRENT_QTD
      when FI_LASTYR_QTD is not null and FI_CURRENT_QTD is null     then FI_LASTYR_QTD
      end as FI_ChangeQTD,
 @DefaultAggregation: #SUM        
 case when FI_LASTYR_YTD is not null and FI_CURRENT_YTD is not null then FI_CURRENT_YTD - FI_LASTYR_YTD
      when FI_LASTYR_YTD is null     and FI_CURRENT_YTD is not null then FI_CURRENT_YTD
      when FI_LASTYR_YTD is not null and FI_CURRENT_YTD is null     then FI_LASTYR_YTD
      end as FI_ChangeYTD, 
  @DefaultAggregation: #SUM 
  case when FI_LASTYR is not null and FI_L2LASTYR is not null then FI_LASTYR - FI_L2LASTYR
       when FI_LASTYR is not null and FI_L2LASTYR is null then FI_LASTYR
       when FI_LASTYR is null and FI_L2LASTYR is not null then FI_L2LASTYR end as FI_ChangeYr,
...
//    case CONCAT(substring(LastYearDate,1,4),CQUARTER) when YearQuarter then SquareFtOccupancy  end as SF_LASTYR_QTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @DefaultAggregation: #SUM
//    @EndUserText.label: 'LY YTD'
//    case substring(LastYearDate,1,4) when CalendarYear then SquareFtOccupancy  end as SF_LASTYR_YTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @DefaultAggregation: #SUM
//    @EndUserText.label: 'Current QTD'
//    case CQUARTER when CalendarQuarter then SquareFtOccupancy  end as SF_CURRENT_QTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @EndUserText.label: 'Current YTD'
//    @DefaultAggregation: #SUM
//    case CYEAR when CalendarYear then SquareFtOccupancy  end as SF_CURRENT_YTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @EndUserText.label: 'Last Year'
//    @DefaultAggregation: #SUM
//    case LYEAR when CalendarYear then SquareFtOccupancy  end as SF_LASTYR,
//   
//    @AnalyticsDetails.query.axis: #ROWS
//    @EndUserText.label: 'Last to LastYear'
//    @DefaultAggregation: #SUM
//    case L2LYEAR when CalendarYear then SquareFtOccupancy  end as SF_L2LASTYR,
//    
...
//    @DefaultAggregation: #SUM
//    @EndUserText.label: 'LY QTD'
//    case CONCAT(substring(LastYearDate,1,4),CQUARTER) when YearQuarter then AnnualConPerSqFt  end as AC_LASTYR_QTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @DefaultAggregation: #SUM
//    @EndUserText.label: 'LY YTD'
//    case substring(LastYearDate,1,4) when CalendarYear then AnnualConPerSqFt  end as AC_LASTYR_YTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @DefaultAggregation: #SUM
//    @EndUserText.label: 'Current QTD'
//    case CQUARTER when CalendarQuarter then AnnualConPerSqFt  end as AC_CURRENT_QTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @EndUserText.label: 'Current YTD'
//    @DefaultAggregation: #SUM
//    case CYEAR when CalendarYear then AnnualConPerSqFt  end as AC_CURRENT_YTD,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @EndUserText.label: 'Last Year'
//    @DefaultAggregation: #SUM
//    case LYEAR when CalendarYear then AnnualConPerSqFt  end as AC_LASTYR,
//    
//    @AnalyticsDetails.query.axis: #ROWS
//    @EndUserText.label: 'Last to LastYear'
//    @DefaultAggregation: #SUM
//    case L2LYEAR when CalendarYear then AnnualConPerSqFt  end as AC_L2LASTYR,  
...
//    case L2LYEAR when CalendarYear then CstDevlop  end as CD_L2LASTYR,
    ...
    @DefaultAggregation: #SUM
    SqFt_910200 / SqFt_910210 as SquareFtOccupancy,
   
    @EndUserText.label: 'AnnualConPerSqFt'
    @DefaultAggregation: #SUM
    SqFt_910120 / SqFt_910200 as AnnualConPerSqFt
