@AbapCatalog.sqlViewName: 'ZCSRPT40Q'
...
@EndUserText.label: 'Cons Analyzer with Reporting Rules'
define view ZC_CnsldtnRpt40Q
  with parameters
  ...
  as select from  ZI_MATRIX_RPT_RULE_CUBE(
...
//  }
 ...
 // @Consumption.filter: {selectionType: #RANGE, multipleSelections: true, mandatory: false}
  ...
  @EndUserText.label: 'Current Quarter Amount'
  CurrPeriodAmt,
  ...
  @Semantics.amount.currencyCode: 'GroupCurrency'
  @AnalyticsDetails.query.hidden: false
  @EndUserText.label: 'Current Year YTD Amount'
  CurrYTDAmt,
  ...
  @Semantics.amount.currencyCode: 'GroupCurrency'
  @AnalyticsDetails.query.hidden: false
  @EndUserText.label: 'Previous Year YTD Amount'  
  PrevYTDAmt,
  ...
  @Semantics.amount.currencyCode: 'GroupCurrency'
  @AnalyticsDetails.query.hidden: false
  @EndUserText.label: 'Previous Year-1  YTD Amount'  
  PrevYR2YTDAmt,  
