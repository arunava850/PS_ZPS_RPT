@AbapCatalog.sqlViewName: 'ZIRPTRULECUB01'
...
@EndUserText.label: 'Consolidation Matrix with Rpt Rules 01'
define view ZI_MATRIX_RPT_RULE_CUBE_01 
 with parameters
  ...
  as select from ZI_MATRIX_RPT_RULE_SUM_01(
