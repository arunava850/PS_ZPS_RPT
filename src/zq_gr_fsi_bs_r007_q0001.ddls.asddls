...
// SQL View Name
@AbapCatalog.sqlViewName: 'ZQGRCBSR07_Q1'
// Query Name
@EndUserText.label: 'RPT0007 - Consolidated Balance Sheet'
...
define view ZQ_GR_FSI_BS_R007_Q0001
  with parameters
...

{
  ...
  key ConsolidationLedger,
      ...
      //     @EndUserText.label: 'Cons. Doc Type'
      //     @AnalyticsDetails.query.axis: #FREE
      //     @AnalyticsDetails.query.display: #KEY_TEXT
      //     @Consumption.filter: {selectionType: #SINGLE, multipleSelections: false, mandatory: false}
      //     @AnalyticsDetails.query.variableSequence : 4
      //     ConsolidationDocumentType,
      //     _DocumentType._Text[1: Language = $parameters.P_Language].ConsolidationDocumentTypeText          as ConsolidationDocumentTypeName,
