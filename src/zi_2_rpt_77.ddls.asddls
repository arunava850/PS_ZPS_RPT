@AbapCatalog.sqlViewName: 'ZI2RPT77'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #NOT_REQUIRED
@EndUserText.label: 'R77 - Interface View (Time Chars) -2'
@Analytics.dataCategory: #CUBE
@VDM.viewType: #COMPOSITE

define view ZI_2_RPT_77
with parameters
     p_qtr: abap.char(1),
     p_year: abap.char(4)

as select from ZI_RPT_77
...

{
   ...
   //where FiscalYear <= $parameters.p_year 
