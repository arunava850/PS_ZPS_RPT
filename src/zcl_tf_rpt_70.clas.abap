CLASS zcl_tf_rpt_70 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  CLASS-METHODS get_rpt70 FOR TABLE FUNCTION ZTF_RPT_70.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
a.hsl
   ...
   and (a.racct = '0000210050' or a.racct = '0000210060') and
   ( a.lokkt = '2350-0075' or a.lokkt = '2350-0070' or a.lokkt = '2350-0100' ) ;
