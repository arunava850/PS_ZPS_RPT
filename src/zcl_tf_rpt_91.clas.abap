CLASS zcl_tf_rpt_91 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  CLASS-METHODS get_rpt91 FOR TABLE FUNCTION ZTF_RPT_91.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS zcl_tf_rpt_91 IMPLEMENTATION.
...
METHOD get_rpt91
 BY DATABASE FUNCTION FOR HDB LANGUAGE SQLSCRIPT OPTIONS READ-ONLY "CDS SESSION CLIENT current
   USING  I_GLAccountLineItem ztrpt_fi_mstr
    skat ska1 cepc  ZI_STAT_DERIV_PDATE ZB_PSEZ_PRCTR_HIER .
...
*                                      and _MSTR.docto
      inner join ZB_PSEZ_PRCTR_HIER as _phier on _phier.HierarchyClass = 'PSCO'
