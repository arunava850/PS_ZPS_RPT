@AbapCatalog.sqlViewName: 'ZIMATRPTRULESUM1'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Cons Data with Reporting Rule - 01'
define view ZI_MATRIX_RPT_RULE_SUM_01 
  with parameters
                                                                       ...
                                                                       c.item    = ZTRX.FinancialStatementItem  
{
 ...
 sum( ZTRX.AmountInGroupCurrency )  as TotalAmt,
    
  @DefaultAggregation: #SUM
 sum( case  
   when c.ritem = 'CSE10000' then zsign * ZTRX.AmountInGroupCurrency
   when c.ritem = 'CSE10100' then zsign * ZTRX.AmountInGroupCurrency
   else 0
  end )  as PrefShareAmt,

 sum( case  
   when c.ritem = 'CSE10200' then zsign * ZTRX.AmountInGroupCurrency
   when c.ritem = 'CSE10300' then zsign * ZTRX.AmountInGroupCurrency
   when c.ritem = 'CSE10400' then zsign * ZTRX.AmountInGroupCurrency
   else 0
  end )   as CommonShareAmt,
...
where
       ZTRX.FiscalYearPeriod between b.CUR_YR_JAN_FROM and b.CUR_PER  //Current YTD Filter
group by
  ConsolidationLedger,
  ConsolidationDimension,
  FiscalYear,
