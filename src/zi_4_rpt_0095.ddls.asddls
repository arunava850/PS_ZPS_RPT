@AbapCatalog.sqlViewName: 'ZI4RPT0095'
...
//    case when LYear is not null and CQuarter is not null and PostingDate <= DATS_ADD_DAYS($parameters.P_ToPostingDate,-365,'NULL')
...
//    @Semantics.quantity.unitOfMeasure: 'StatUnit'
//    case when CYEAR is not null and CQuarter is not null and PostingDate <= $parameters.P_ToPostingDate
