...
@AbapCatalog.sqlViewName: 'ZIRTP772'
...
define view ZI_RPT_77_4
  with parameters
    p_qtr  : abap.char(2),
    p_year : gjahr

  as select from ZTF_RPT_77_1( p_clnt:$session.client , p_qtr: $parameters.p_qtr , p_year: $parameters.p_year  )
{
  Mainnode,
  Subnode,
  Ledger,
